...
class analyize():
    ...
    def calculate_elastic_modulus(self):
        ...
        a = 0
        # ===== Define Strain =====
        R = .267729 # ratio of gauge 9/16" displacement to pin displacement
        frame_displacement = (self.frame_displacement_function*self.force) # frame displacement function
